    ...
    static Stream<Arguments> casesTotalIncome() {
        ...
        return Stream.of(
                Arguments.of(ClientFactory.newInstance(
                                Util.generateDeposits(7, 5).toArray(Deposit[]::new)), "3829.21", "1875.05",
                        Util.nextInt(r, 0, 10), "511.74"),
                Arguments.of(ClientFactory.newInstance(
                                Util.generateDeposits(5, 2347).toArray(Deposit[]::new)), "2040.26", "1505.91",
                        Util.nextInt(r, 0, 10), "1505.91"),
                Arguments.of(ClientFactory.newInstance(
                                Util.generateDeposits(5, 748).toArray(Deposit[]::new)), "2072.88", "610.85",
                        Util.nextInt(r, 0, 10), "0.00"),
                Arguments.of(ClientFactory.newInstance(
                                Util.generateDeposits(5, 12).toArray(Deposit[]::new)), "2070.36", "790.95",
                        Util.nextInt(r, 0, 10), "0.00"),
                Arguments.of(ClientFactory.newInstance(
                                Util.generateDeposits(12, 15).toArray(Deposit[]::new)), "2576.04", "728.88",
                        Util.nextInt(r, 0, 10), "728.88")
        );
    }
