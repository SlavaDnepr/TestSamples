...
class DepositTest {
    ...
    static Stream<Arguments> casesDepositIncome() {
        ...
        Stream<Arguments> baseDeposits = Stream.generate(() -> Arguments.of(Util.executableMap.get(0)
                        .execute(new BigDecimal("1000"), Util.nextInt(r, 1, 10)), it.next()))
                .limit(10);
        Stream<Arguments> specialDeposits = Stream.generate(() -> Arguments.of(Util.executableMap.get(1)
                        .execute(new BigDecimal("1000"), Util.nextInt(r, 1, 10)), it.next()))
                .limit(10);
        Stream<Arguments> longDeposits = Stream.generate(() -> Arguments.of(Util.executableMap.get(2)
                        .execute(new BigDecimal("1000"), Util.nextInt(r, 1, 10)), it.next()))
                .limit(10);
